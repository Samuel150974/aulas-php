...
<body>
    <div class="container">
        ...
        <h2>mb_strtoupper()</h2>
        <p>Conversão para maíusculas: <?= mb_strtoupper($texto) ?></p>
        ...
        $fraseComSubistituicaoDePalavra = str_ireplace("bobo", "cara legal", $frase);

        // Procurando por uma LISTA de palavras e substituindo por outra coisa
        $fraseCensurada = str_ireplace(
            ["panaca", "burro", "idiota", "chato", "bobão", "bobo"],
            "😊😁",
            $frase
        ...
        <p>Frase com substituição de palavra: <?= $fraseComSubistituicaoDePalavra ?></p>
        <p>Frase censurada: <?= $fraseCensurada ?></p>

        <h2>string_tags()</h2>
        <?php
        $codigoHTML = " <h3> HTML5 - <a href='https://www.sp.senac.br'>Senac</a></h3>";
